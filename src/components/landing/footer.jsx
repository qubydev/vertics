            ...
            <div className="max-w-5xl mx-auto px-4 flex flex-col gap-12 md:flex-row md:justify-between relative z-10">
                <div className="flex flex-col items-start gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <Link href="#" aria-label="Vertics on X" className="flex size-8 items-center justify-center border border-border text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
                            <FaXTwitter className="size-4" />
                        </Link>
                        <Link href="#" aria-label="Vertics on LinkedIn" className="flex size-8 items-center justify-center border border-border text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
                            <FaLinkedinIn className="size-4" />
                        </Link>
                        <Link href="#" aria-label="Email Vertics" className="flex size-8 items-center justify-center border border-border text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
