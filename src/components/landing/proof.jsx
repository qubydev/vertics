    ...
    return (
        <div className="max-w-5xl w-full mx-auto flex items-center justify-center py-8 px-6">
            <div className='flex w-full items-center justify-between text-center max-w-3xl'>
                <div className="px-2">
                    <p className="text-3xl md:text-5xl font-bold tracking-tighter leading-none">500+</p>
                ...
                <div className="px-2">
                    <p className="text-3xl md:text-5xl font-bold tracking-tighter leading-none">1k+</p>
                    <p className="text-xs md:text-sm text-muted-foreground mt-2">traffic analyzed</p>
                </div>
                ...
                <div className="px-2">
                    ...
                    <p className="text-xs md:text-sm text-muted-foreground mt-2">active users</p>
                </div>
            </div>
        </div>
    )
